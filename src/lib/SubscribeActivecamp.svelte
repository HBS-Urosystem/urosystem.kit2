...
<style>
  ...
  #_form_9_ ._submit { -webkit-appearance:none; appearance:none; cursor:pointer; /*font-family:arial, sans-serif;*/ font-size:14px; text-align:center; background:#51b3d6 !important; border:0 !important; -moz-border-radius:1000px !important; -webkit-border-radius:1000px !important; border-radius:1000px !important; /*color:#fff !important;*/ padding:10px !important; }
  ...
  #_form_9_ ._error-inner { padding:8px 12px; background-color:#f37c7b; font-size:14px; color:#fff; text-align:center; text-decoration:none; -webkit-border-radius:4px; -moz-border-radius:4px; border-radius:4px; }
  ...
  @media all and (min-width:320px) and (max-width:667px) { 
    ...
    #_form_9_ input[type="text"] { padding-left:10px; padding-right:10px; font-size:16px; line-height:1.3em; -webkit-appearance:none; appearance:none; }
  ...
  #_form_9_ { position:relative; text-align:left; margin:25px auto 0; padding:20px; -webkit-box-sizing:border-box; -moz-box-sizing:border-box; box-sizing:border-box; border:2px solid #366076 !important; -moz-border-radius:16px !important; -webkit-border-radius:16px !important; border-radius:16px !important; color:#dfeef6 !important; }
  ...
  #_form_9_ * { font-size:18px; }
  #_form_9_ ._form-title { font-size:26px; }
  #_form_9_ label { line-height:0; padding-top:0 !important; }
  #_form_9_._form._inline-form._inline-style ._button-wrapper { margin-top:0; padding:5px; }
  #_form_9_ ._submit { margin:0; font-size:16px; padding-inline:20px !important; padding-block:0px !important; }
  #_form_9_ input { color:white; background-color:transparent; }
</style>
...
<div style="text-align: center;">
  <form method="POST" action="https://urosystem.activehosted.com/proc.php" id="_form_9_" class="_form _form_9 _inline-form _inline-style " novalidate>
    ...
    <input type="hidden" name="or" value="c41567325f43525990de055cb24f41b5" />
    <div class="_form-content">
      <div class="_form_element _x99582598 _inline-style _clear" >
        <div class="_form-title">
          Subscribe for our Event Updates
        </div>
      </div>
      <div class="_form_element _x97093504 _inline-style _clear" >
        <div class="_html-code">
          <p>
            Receive an email notification whenever there is a new event!
          </p>
        </div>
      </div>
      <div class="_form_element _x30806842 _inline-style " >
      ...
      <div class="_form_element _x56934155 _inline-style " >
  ...
  (function() {
    ...
    var form_submit = function(e) {
      ...
      if (validate_form()) {
        ...
        _load_script('https://urosystem.activehosted.com/proc.php?' + serialized + '&jsonp=true');
      }
      return false;
    };
