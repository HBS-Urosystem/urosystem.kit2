  ...
  - type: article
    text: >-
      ...
      * Адрес электронной почты
      ...
      Штаб-квартира PayPal: 2211 North First Street, Сан-Хосе, Калифорния 95131, США - [www.paypal.com](http://www.paypal.com/)
      ...
      * доказано, что контроль данных был незаконным.
      ...
      Посетитель или Пользователь имеет право реализовать свои права в форме иска в гражданском суде. Оценка правовых действий находится в компетенции суда. Жалобу необходимо подать в суд по месту жительства Посетителя. Дополнительную информацию о венгерских судах можно найти на веб-странице: <http://birosag.hu/torvenyszekek>.
